...
function annoyingSong(number){
     for (let i = number; i > 0; i--){
      return `${i} bottles of soda on the wall, ${i} bottles of soda, take one down and pass it around ${i-1} bottles of soda on the wall`;
     }
}
